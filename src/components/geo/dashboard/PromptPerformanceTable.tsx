      ...
      <div className="flex items-center gap-3 mb-4 flex-wrap">
        <div className="relative flex-1 min-w-[200px]">
          ...
          <input
            ...
            className="w-full pl-8 pr-3 py-2 text-sm border border-[#E5E5E1] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#171717]/20 focus:border-[#E5E5E1] bg-white"
          />
        </div>
                ...
                <td className="px-4 py-3">
                  {r.business_mentioned ? (
                    <span className="inline-flex items-center gap-1 text-[12px] font-semibold text-[#166534]">
                      ...
                      Won
                      {r.mention_position && (
                        <span className="text-[#A3A3A0] font-normal">#{r.mention_position}</span>
                      )}
                    </span>
                  ) : (
